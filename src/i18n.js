      ...
      en: {
        translation: {
          ...
          community: [
            ...
            "Big Sister with Big Brothers Big Sisters Winnipeg",
      ...
      fr: {
        translation: {
          description: {
            ...
            address: "Okotoks, Alberta",
            skill: [
              "Résolveuse créative de problèmes",
              "Développement logiciel et base de données",
              "Leadership de projet",
              "Maîtrise bilingue (français/anglais)",
          ...
          community: [
            "Programme d'échange de reins",
            "Grande Sœur avec Grands Frères Grandes Sœurs Winnipeg",
