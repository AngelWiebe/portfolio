      ...
      en: {
        translation: {
          description: {
            ...
            bio: "Full-stack developer with 8+ years of turning ideas into reality. I specialize in crafting beautiful, responsive front-ends with React and TypeScript, while building robust backends that scale. From mobile apps to web platforms, I bring projects from prototype to production—without the drama. Always learning, always shipping.",
          },
          aria: {
          ...
          header: "From prototype to production without the drama",
          subheader: "Frontend and mobile specialist with a backend backbone.",
      ...
      fr: {
        translation: {
          description: {
            ...
            bio: "Développeuse full-stack avec plus de 8 ans d'expérience à transformer des idées en réalité. Je me spécialise dans la création d'interfaces front-end élégantes et réactives avec React et TypeScript, tout en construisant des backends robustes qui évoluent. Des applications mobiles aux plateformes web, j'amène les projets du prototype à la production—sans complications. Toujours en apprentissage, toujours en livraison.",
          },
          aria: {
          ...
          header: "Du prototype à la production, sans complications",
          subheader:
            "Spécialiste front-end et mobile, soutenu par un back-end robuste.",
